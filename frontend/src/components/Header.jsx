...
const Header = () => {
  ...
  console.log(`userinfo inside Header is ${userInfo?.image}`)
  // const decodedImage = "data:image/jpeg;base64,"+userInfo?.image;
  // console.log(`userinfo inside decoded image string is ${decodedImage}`)
