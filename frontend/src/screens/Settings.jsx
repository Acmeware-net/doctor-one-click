...
const Settings = () => {
  ...
  const previewFile = () => {
    console.log('preview file fired!')
    const preview = document.getElementById("imgdest");
    const file = document.getElementById("imgsrc").files[0];
            ...
            <div>
              ...
              <div className='mb-2' >
                ...
                <input
                  ...
                  className=' p-2 rounded-md border border-gray-300 mb-5 transition-all focus:border-blue-400 focus:shadow-md focus:shadow-blue-200'
                />
                <img src="" width="80" height="80" alt="Image preview" id='imgdest'/>
                
                <br/>
                <span className='text-red-700 mb-2'>Only .png, .jpg, .jpeg, .gif file types are accepted</span>
              </div><br/>
